...
class DataFoursquare(object):
    ...
    def load_pickle(self):
        ...
        json_file = open('/home/local/ASUAD/ychen404/Code/DeepMove_new/data/tweets-cikm.pk')
        
        with open(self.SAVE_PATH + self.save_name + '.pk') as pk_file:
...
if __name__ == '__main__':
    ...
    print('Loading pickle from {}'.format(data_generator.SAVE_PATH + data_generator.save_name + '.pk'))
    data_json = data_generator.load_pickle()
